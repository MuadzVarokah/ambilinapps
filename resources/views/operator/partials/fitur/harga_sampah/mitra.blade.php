        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3 class="title" style="text-transform: capitalize">Harga Sampah {{$mitra}}</h3>
                    <p class="text-subtitle text-muted">Harga sampah {{$mitra}} yang tercatat di Ambilin</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('index-operator') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page" style="text-transform: capitalize">Harga Sampah {{$mitra}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            @foreach ($data as $data_user)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if ($data_user->aktif == '1')
                                            <a href="{{ route('harga_sampah_toggle-operator') }}?jenis={{$mitra}}&id={{ $data_user->id }}"
