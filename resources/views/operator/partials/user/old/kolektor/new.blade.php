        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3 class="title">Kolektor - Pengguna Baru</h3>
                    <p class="text-subtitle text-muted">Daftar kolektor - pengguna baru yang tercatat di Ambilin</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('index-operator') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Kolektor - Pengguna Baru</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-responsive" id="table1" style="font-size: 90%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td>
                                    {{ $data_user->alamat_lokasi }}, {{ $data_user->kel }}, {{ $data_user->kec }}, {{ $data_user->kab }}, {{ $data_user->prov }}
                                </td> --}}
                                ...
                                <td class="text-center">
                                    <button class="btn btn-outline-warning btn-sm" style="margin: 0.15rem 0;" data-bs-toggle="modal tooltip" data-bs-target="#edit" data-bs-placement="top" title="Lengkapi Data"><i class="fa-solid fa-pen-to-square"></i></button>
