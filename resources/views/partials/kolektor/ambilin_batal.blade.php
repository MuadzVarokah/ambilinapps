    ...
    <table class="table table-sm table-borderless" style="margin: 0;">
        <tr>
            ...
            <td style="padding-left: 0; padding-right: 0; padding-top: 0.5rem;">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active position-relative" style="padding:0.5rem 0.75rem" aria-current="page" href="javascript:void(0)">Dibatalkan
                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                                {{ $count_batal }}
                            </span>
                        </a>
    ...
    <div style="padding:0.5rem 1rem">
        <div class="alert alert-secondary d-flex justify-content-center align-items-center" role="alert"
            ...
            <div class="row" style="width:100%;height:auto">
                ...
                <div class="col-12">
                    <a href="{{ route('ambilin_edit', ['id' => $ambil->id_ambilin]) }}" role="button" class="btn btn-warning"
