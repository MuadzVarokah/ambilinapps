...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style='background-color:#176e41'>
        ...
        <div class="container-fluid">
            <!-- Navbar brand -->
            <a class="navbar-brand" href="{{ session('paskas_url') }}"><i class="fa-solid fa-chevron-left"></i></a>
            <p class="navbar-brand" style="margin:0; font-size:90%;font-weight:bold">PASKAS | Toko {{ $user->nama }}</p>
    ...
    <div class="container">
        <div class="d-flex justify-content-center" style="margin-top: 1rem;">
            <a href="{{ route('paskas_baru') }}" role="button" class="btn btn-success"
                ...
                <div class="row d-flex justify-content-center" style="padding: 0.5rem 0;">
                    @foreach ($proses_cek as $proses)
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6" style="margin: 0.5rem 0; ">
                            <a href="{{ route('detail', ['fitur' => 'paskas', 'id' => $proses->id]) }}"
                                ...
                                <div class="card border border-1 h-100" style="background-color: gainsboro;">
                                    <div class="card border border-0" style="aspect-ratio: 1 / 1;">
                                        ...
                                        @php
                                            ...
                                            if (!empty($proses->foto) && file_exists('public/img/paskas/' . $proses->foto)) {
                                                $foto_paskas = 'public/img/paskas/' . $proses->foto;
                                            }
                                        @endphp
            ...
            <div class="tab-pane fade" id="nav-lolos" role="tabpanel" aria-labelledby="nav-lolos-tab" tabindex="0">
                <div class="row d-flex justify-content-center" style="padding: 0.5rem 0;">
                    @foreach ($lolos_cek as $lolos)
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6" style="margin: 0.5rem 0; ">
                            <a href="{{ route('detail', ['fitur' => 'paskas', 'id' => $lolos->id]) }}"
                                style="text-decoration: none; color:black;">
                                <div class="card border border-1 h-100" style="background-color: gainsboro;">
                                    <div class="card border border-0" style="aspect-ratio: 1 / 1;">
                                        <div class="position-absolute top-0 start-0">
                                        ...
                                        @php
                                            $foto_paskas = "https://ambilin.com/img/png/ambilin.png";
                                            if (!empty($lolos->foto) && file_exists('public/img/paskas/' . $lolos->foto)) {
                                                $foto_paskas = 'public/img/paskas/' . $lolos->foto;
                                            }
                                        @endphp
                                        <img src="{!! asset($foto_paskas) !!}" class="card-img-top"
                                            alt="{{$lolos->judul}}"
            ...
            <div class="tab-pane fade" id="nav-tidak_lolos" role="tabpanel" aria-labelledby="nav-tidak_lolos-tab" tabindex="0">
                ...
                <div class="row d-flex justify-content-center" style="padding: 0.5rem 0;">
                    @foreach ($tidak_lolos_cek as $tidak_lolos)
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6" style="margin: 0.5rem 0; ">
                            <a href="{{ route('detail', ['fitur' => 'paskas', 'id' => $tidak_lolos->id]) }}"
                                style="text-decoration: none; color:black;">
                                <div class="card border border-1 h-100" style="background-color: gainsboro;">
                                    <div class="card border border-0" style="aspect-ratio: 1 / 1;">
                                        <div class="position-absolute top-0 start-0">
                                        ...
                                        @php
                                            $foto_paskas = "https://ambilin.com/img/png/ambilin.png";
                                            if (!empty($tidak_lolos->foto) && file_exists('public/img/paskas/' . $tidak_lolos->foto)) {
                                                $foto_paskas = 'public/img/paskas/' . $tidak_lolos->foto;
                                            }
                                        @endphp
                                        <img src="{!! asset($foto_paskas) !!}" class="card-img-top"
            ...
            <div class="tab-pane fade" id="nav-laku" role="tabpanel" aria-labelledby="nav-laku-tab" tabindex="0">
                <div class="row d-flex justify-content-center" style="padding: 0.5rem 0;">
                    @foreach ($barang_laku as $laku)
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6" style="margin: 0.5rem 0; ">
                            <a href="{{ route('detail', ['fitur' => 'paskas', 'id' => $laku->id]) }}"
                                style="text-decoration: none; color:black;">
                                <div class="card border border-1 h-100" style="background-color: gainsboro;">
                                    <div class="card border border-0" style="aspect-ratio: 1 / 1;">
                                        <div class="position-absolute top-0 start-0">
                                        ...
                                        @php
                                            $foto_paskas = "https://ambilin.com/img/png/ambilin.png";
                                            if (!empty($laku->foto) && file_exists('public/img/paskas/' . $laku->foto)) {
                                                $foto_paskas = 'public/img/paskas/' . $laku->foto;
                                            }
                                        @endphp
                                        <img src="{!! asset($foto_paskas) !!}" class="card-img-top"
                                            alt="{{$laku->judul}}"
                                    ...
                                    <div class="container"
                                        ...
                                        <div class="position-absolute bottom-0 end-0">
                                            <div class="row d-flex flex-column">
                                                @if ($laku->harga != $laku->harga_kesepakatan)
                                                    <div class="col-auto">
                                                        <p class="text-secondary strikethrough"
                                                            style="margin: 0 0.5rem -0.4rem 0; font-weight: 600; text-align: end; font-size: smaller;">
                                                ...
                                                <div class="col-auto" style="padding-left: unset">
                                                    <p class="text-success"
                                                        style="margin: 0 0.5rem 0.25rem 0; font-weight: 600; text-align: end;">
                                                        <small>Rp.</small> {{ number_format($laku->harga_kesepakatan, 0, ',', '.') }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
        ...
        <!--accordions-->
        <div class="accordion" id="paskas_jualan">
            <!--Proses cek-->
            <div class="accordion-item">
                <h2 class="accordion-header" id="prosesCek-heading">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        data-bs-target="#prosesCek-collapse" aria-expanded="true" aria-controls="prosesCek-collapse">
                        <b>Proses Cek</b>
                    </button>
                </h2>
                <div id="prosesCek-collapse" class="accordion-collapse collapse show" aria-labelledby="prosesCek-heading">
                    <div class="accordion-body">
                        <div class="container">
                            <table class="table table-striped table-borderless" style=" width: 100%">
                                @foreach ($proses as $semua)
                                    @php
                                        $foto = $semua->foto;
                                    ...
                                    height: 8rem;
                                    ">
                                                <img src="{{ $imgurl }}" class="img-fluid" alt="{{ $foto }}"
                                                    style=" border-radius: 5%;object-fit: cover;height: 8rem;width:auto">
                                            </div>
                                        </td>
                                        <td class="col-6">
                                            <p style="font-weight:700">{{ $semua->judul }}</p>
                                            <p style="font-weight:500;margin: 0">Rp.
                                                {{ number_format($semua->harga, 0, ',', '.') }}</p>
                                            <p style="margin: 0;padding-top:1rem">{{ Str::limit($semua->deskripsi, 32) }}
                                            </p>
                                            <p style="margin: 0;padding-top:0.25rem">kondisi: {{ $semua->kondisi }}</p>
                                            <p style="margin: 0;padding-top:0.25rem">Jenis: {{ $semua->fungsi }}</p>
                                            <a href="detail/paskas/{{ $semua->id }}" class="btn btn-success"
                                                style="margin: 0.5rem 0; text-transform: capitalize; font-size: 90%; font-weight: 600; padding: 0.25rem 1rem;">detail</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="lolosCek-heading">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        style="margin-top:2px" data-bs-target="#lolosCek-collapse" aria-expanded="false"
                        aria-controls="lolosCek-collapse">
                        <b>Lolos Cek</b>
                    </button>
                </h2>
                <div id="lolosCek-collapse" class="accordion-collapse collapse" aria-labelledby="lolosCek-heading">
                    <div class="accordion-body">
                        <div class="container">
                            <table class="table table-striped table-borderless" style=" width: 100%">
                                @foreach ($lolos as $semua)
                                    @php
                                        $foto = $semua->foto;
                                        $imgurl = 'public/img/paskas/' . $foto . '';
                                    @endphp
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="tidakLolosCek-heading">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        style='margin-top:2px' data-bs-target="#tidakLolosCek-collapse" aria-expanded="false"
                    ...
                    <div class="accordion-body">
                        <div class="container">
                            ...
                            <div class="alert alert-danger d-flex justify-content-center align-items-center"
                                role="alert">
                                <p> Peraturan komunitas Ambilin bisa dibaca <a href="#"
                                        style="text-weight:bold">disini</a>
                                </p>
                            </div>
                        </div>
                    </div>
