                    ...
                    <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                        <div class="container d-flex justify-content-center align-items-center">
                            <div class="row d-flex justify-content-center align-items-center">
                                <h2 class="col-12 text-center" style="font-size: 5rem; font-weight:600; margin: 0;">419</h2>
                                <p class="col-12 text-center" style="font-size: 1.5rem; font-weight:400; margin: 0; padding-bottom: 0.5rem;">Laravel POST Error</p>
