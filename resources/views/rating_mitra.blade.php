        ...
        <div class="row d-flex justify-content-center">
            @if ($status == 'beri')
                <div class="rate">
                    @php
                        ...
                        $weekAfter = \Carbon\Carbon::parse($ambilin->waktuubah)
                            ->addWeek()
                            ->format('Y-m-d H:i:s');
                        $today = \Carbon\Carbon::today()->format('Y-m-d H:i:s');
                    @endphp

                    <form action="{{ route('post_ratingku_mitra', ['id_ambilin' => $ambilin->id]) }}" method="POST">
                        @csrf
                        <div class="col-auto">
                            <div class="rating">
                                {{-- {{dd($ada)}} --}}
                        ...
                        <div class="col-12">
                            ...
                            @endif
                                <textarea type="text" name="reason" id="reason" class="form-control rounded-0" rows="5" placeholder="Keterangan mengenai mitra ini">@if(!empty($rating_ku)){{ $rating_ku->keterangan }}@endif</textarea>
            ...
            @else
                <div>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-auto">
                            <a class="btn btn-outline-warning rounded-1" href="{{ route('beri_rating_mitra', ['id_ambilin' => $ambilin->id]) }}" style="text-transform: capitalize; font-weight: 600;"><i class="fa-regular fa-pen-to-square"></i>&nbsp;&nbsp;Ubah Penilaian</a>
                        </div>
                    </div>
                    @endif
                </div>
