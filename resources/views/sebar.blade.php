...
<div class='container'style="width:100%;padding-top:1rem">
    <div class="alert alert-danger d-flex justify-content-center align-items-center" role="alert">
        ...
        @endphp
        <p>Fitur Sebar saat ini belum tersedia.
    ...
    <div style="width:100%; padding-bottom: 1rem">
        <div style="padding-top:1rem; padding-bottom:1rem" class="container d-flex justify-content-between">
            <a href="{{ route('sebarku') }}" role="button" class="btn btn-success" style="width: 86%; text-transform: capitalize; font-size: 90%; font-weight: 600; padding: 0.5rem 0;">Sebarku</a>
            <button role="button" class="btn btn-success" style="width: 11%; font-weight: 600;" id="infoSebarBtn"><i class="fa-solid fa-circle-info"></i></button>
        </div>
        <div class="toast-container position-fixed top-0 start-50 translate-middle-x" style="padding-top: 4.4rem;">
            <div class="toast align-items-center text-bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true" id="infoSebar" style="font-weight: 600;">
                <div class="d-flex">
                <div class="toast-body">
                    Sedekah Barang Bekas Pilihan
                </div>
        ...
        <script>
            const toastTrigger = document.getElementById('infoSebarBtn')
            const toastLiveExample = document.getElementById('infoSebar')
            if (toastTrigger) {
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-6"
                    style="padding-right:1%; font-weight:bold; width:auto">
                    Filter :</div>
                @if (isset($fil_kata))
                ...
                @if (isset($fil_jenis) || $fil_kata || $fil_kondisi)
                    <div class="card col-lg-3 col-md-4 col-sm-6 col-6 bg-danger border-danger"
                        style="width:auto;">
                    ...
                    <td class="col-6 d-flex align-items-center justify-content-center">
                        <div class="card bg-transparent" style="border: 0; outline: 0; box-shadow: 0 0 0 0 rgb(0 0 0), 0 0 0 0 rgb(0 0 0); width: 100%;">
                            <div class="card-body" style="padding-top: 0; padding-bottom: 0;">
                                ...
                                <a href="detail/sebar/{{$barang->id}}" class="btn btn-success" style="margin: 0.5rem 0; text-transform: capitalize; font-size: 90%; font-weight: 600; padding: 0.25rem 1rem;">detail</a>
                            </div>
                        </div>
                    </td>
                <td class="col-6 d-flex align-items-center justify-content-center">
             ...
             <div class="row d-flex justify-content-center" style="padding: 0.5rem 0;">
                @if ($barang == 'kosong')
                    ...
                    <div class="col-12 d-flex justify-content-center">
                        <a href="javascript:void(0)" class="btn btn-success btn-small" style="text-transform: capitalize" onclick="getLocationSebar()">Coba Lagi</a>
                        <script>
                ...
                @else
                    ...
                    @php $i++; @endphp
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6" style="margin: 0.5rem 0; ">
                            <a href="{{ route('detail', ['fitur' => 'sebar', 'id' => $barang->id]) }}"
                                ...
                                <div class="card border border-1 h-100" style="background-color: gainsboro;">
                                    <div class="card border border-0" style="aspect-ratio: 1 / 1;">
                                        ...
                                        @php
                                            ...
                                            if (!empty($barang->foto) && file_exists('public/img/sebar/' . $barang->foto)) {
                                                $foto_sebar = 'public/img/sebar/' . $barang->foto;
                                            }
                                        @endphp
