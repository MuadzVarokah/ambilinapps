            ...
            <div class="container py-4">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                        ...
                        <form action="{{route('post_paskas')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <!-- Harga Penawaran -->
                            <label class="form-label" for="harga_penawaran" style="padding-top: 10px">Harga Penawaran (Rp.) <font color='#ff0000'>*</font></label>
                            <input type="number" min="1000" name="harga" id="harga_penawaran" class="form-control @error('harga') is-invalid @enderror" style="background-color:white;" placeholder="Harga Penawaran (Rp.)" required/>
                            @error('harga')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            @else
                                ...
                                @enderror
                            @endif
                            <p class="text-secondary" style="font-size: 80%" disabled>Informasi lokasi yang ditampilkan di aplikasi tidak akan detail hanya nama kecamatan dan kota/kab</p>
